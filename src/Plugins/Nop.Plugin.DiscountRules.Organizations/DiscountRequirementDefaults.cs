...
namespace Nop.Plugin.DiscountRules.Organizations
{
    ...
    public static class DiscountRequirementDefaults
    {
        ...
        /// </summary>
        public const string SystemName = "DiscountRequirement.MustBeAssignedToOrganization";

        /// <summary>
        /// The key of the settings to save restricted customer roles
        /// </summary>
        public const string SettingsKey = "DiscountRequirement.MustBeAssignedToOrganization-{0}";

        /// <summary>
        /// The HTML field prefix for discount requirements
        /// </summary>
        public const string HtmlFieldPrefix = "DiscountRulesOrganizations{0}";
    }
}
