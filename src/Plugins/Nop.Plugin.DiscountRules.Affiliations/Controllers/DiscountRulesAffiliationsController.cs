...
using Nop.Plugin.DiscountRules.Affiliations.Models;
...
namespace Nop.Plugin.DiscountRules.Affiliations.Controllers
{
    [AuthorizeAdmin]
    [Area(AreaNames.Admin)]
    public class DiscountRulesAffiliationsController : BasePluginController
    {
        #region Fields
        ...
        public DiscountRulesAffiliationsController(ICustomerService customerService,
        ...
        public IActionResult Configure(int discountId, int? discountRequirementId)
        {
            ...
            var restrictedAffiliation = _settingService.GetSettingByKey<string>(string.Format(DiscountRequirementDefaults.SettingsKey, discountRequirementId ?? 0));

            var model = new RequirementModel
            {
                RequirementId = discountRequirementId ?? 0,
                DiscountId = discountId,
                Affiliation = restrictedAffiliation
            };
            ...
            return View("~/Plugins/DiscountRules.Affiliations/Views/Configure.cshtml", model);
        }
