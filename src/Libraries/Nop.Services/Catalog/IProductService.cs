...
namespace Nop.Services.Catalog
{
    ...
    public partial interface IProductService
    {
        ...
        /// <returns>Products</returns>
        IPagedList<Product> GetLowStockProducts(int? vendorId = null, bool? showHidden = false,
        ...
        IPagedList<ProductAttributeCombination> GetLowStockProductCombinations(int? vendorId = null, bool? showHidden = false,
            int pageIndex = 0, int pageSize = int.MaxValue, bool getOnlyTotalCount = false);
